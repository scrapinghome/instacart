        ...
        <main class="w-full bg-white" >
            ...
            <section class="py-16 flex flex-col bg-gray-100">
                <div class="container">
                    ...
                    <h2 class="text-black text-2xl font-bold py-2">
                        Interpretation 
                    </h2> 
                    <p class="text-gray-600 text-md font-normal  py-2">
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">
                        ...
                        <ul style="list-style-type: circle;">
                             ...
                             <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fridgii LLC , 495 85th Cir.</li>
                             ...
                             <li>Website refers to Fridgii, accessible from https://fridgii.com/</li>
            ...
            <section class="py-16 flex flex-col bg-gray-100">
                <div class="container">
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">
                        ...
                        Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: [Use of Cookies by Free Privacy Policy](https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking). <br><br>
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</p>
                    <h2 class="text-black text-2xl font-bold py-2">
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">The Company will retain Your Personal Data only for as long as is necessary
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">Your information, including Personal Data, is processed at the Company's
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">If the Company is involved in a merger, acquisition or asset sale, Your
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">Under certain circumstances, the Company may be required to disclose Your
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
                    <ul style="list-style-type: circle;">
                    ...
                    <p class="text-gray-600 text-md font-normal  py-2">
                        ...
                        <ul style="list-style-type: circle;">
                         <li>By email: sale@fridgii.com</li>
                         <li>By phone number: 833-524-2756</li>
                    </ul>
                    </p>
